...
# order groq -> google -> deepseek -> cerebras if the preferred one fails.
GROQ_API_KEY=...
GOOGLE_API_KEY=...
DEEPSEEK_API_KEY=...
CEREBRAS_API_KEY=...
