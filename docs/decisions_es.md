...
2. ✅ **Hecho, en tres intentos (2026-08-15) — el tercero funciona sin depender de `geocodeConfidence`.**
   ...
   - Pendiente: Diego corre el export una vez más contra Neo4j real y confirma el conteo final. Esperable una baja notable desde 170 — trade-off correcto (precisión sobre cobertura).
